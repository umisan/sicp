...
(define ln2-stream
  (partital-sum (alter-stream 1)))

(display-partial-stream ln2-stream 10)
...
(display-partial-stream ln2-euler-stream 10)

(newline)

(define ln2-tableau-stream
  (accelerated-sequence euler-transform ln2-stream))

(display-partial-stream ln2-tableau-stream 10)
