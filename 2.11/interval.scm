...
(define (mul-interval2 x y)
  (cond ((and (>= (lower-bound x) 0) (>= (upper-bound x) 0) (>= (lower-bound y) 0) (>= (upper-bound y) 0))
        ...
        (else (make-interval (* (upper-bound x) (lower-bound y)) (* (lower-bound x) (lower-bound y))))))
...
(print (mul-interval (make-interval 10 20) (make-interval 10 20)))
(print (mul-interval (make-interval 10 20) (make-interval -10 20)))
(print (mul-interval (make-interval 10 20) (make-interval -10 -20)))
(print (mul-interval (make-interval -10 20) (make-interval 10 20)))
(print (mul-interval (make-interval -10 -20) (make-interval 10 20)))
...
(print (mul-interval2 (make-interval 10 20) (make-interval 10 20)))
(print (mul-interval2 (make-interval 10 20) (make-interval -10 20)))
(print (mul-interval2 (make-interval 10 20) (make-interval -10 -20)))
(print (mul-interval2 (make-interval -10 20) (make-interval 10 20)))
(print (mul-interval2 (make-interval -10 -20) (make-interval 10 20)))
